...
import 'package:testbar4/services/Fire_User.dart'; // ตรวจสอบให้แน่ใจว่าพาธนี้ถูกต้อง
...
class UserDataPV extends ChangeNotifier {
  ...
  Future<void> _initializeUserData() async {
    ...
    _checkAdminStatus();
    print(
        "[Provider] Userdata :$userData"); // ตรวจสอบว่าผู้ใช้เป็นผู้ดูแลหรือไม่ตามข้อมูลที่ดึงมา
  }
  ...
  void clearUserData() {
    ...
    print(
        "[UserProvider][clearUserData]-----> userData: $_userData, isAdmin: $isAdmin");
  }
}
