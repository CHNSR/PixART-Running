...
import 'package:testbar4/screens/layer2/activity/componente/acCpEdit.dart';
import 'package:testbar4/screens/layer2/location/component/addlocation.dart';
import 'package:testbar4/screens/layer2/location/component/card.dart';
import 'package:provider/provider.dart';
import 'package:testbar4/provider/provider_userData.dart'; // Adjust the path accordingly
...
class _EditlocationPageState extends State<EditlocationPage> {
  ...
  Widget build(BuildContext context) {
    final userDataProvider =
        Provider.of<UserDataPV>(context); // Get the provider
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              if (userDataPV
                  .isAdmin) // ถ้าเป็นแอดมินให้แสดงตัวเลือกเพิ่มตำแหน่งสาธารณะ
                ListTile(
                  title: Text(
                    'Public location',
                    style: GoogleFonts.pixelifySans(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => AddLocationPageMap(
                                mapStatus: false,
                              )),
                    );
                  },
