...
import 'package:testbar4/services/Fire_Shoes.dart';
...
class _SelectShoesState extends State<SelectShoes> {
  ...
  void _showShoeSelector(
      BuildContext context, List<Map<String, dynamic>> shoesData) {
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    double shoeRangeInFire = shoesData[index]['shoesRange']
                        as double; // Assuming `shoesRange` is a double
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                              ...
                              Expanded(
                                child: SliderTheme(
                                  data: SliderThemeData(
                                    disabledActiveTrackColor: Colors
                                        .black, // สีของ track เมื่อ slider ถูกปิดการใช้งานและเป็น active
                                    disabledInactiveTrackColor: Colors
                                        .yellow, // สีของ track เมื่อ slider ถูกปิดการใช้งานและเป็น inactive
                                    disabledThumbColor: Colors.black,
                                  ),
                                  child: Slider(
                                    value: shoesRange,
                                    min:
                                        0, // Adjust the min value based on your requirements
                                    max:
                                        100, // Adjust the max value based on your requirements
                                    divisions:
                                        100, // Optional: Adjust based on your range granularity
                                    onChanged:
                                        null, // Makes the slider non-interactive
                                  ),
                                ),
                              ),
                          ...
                          onTap: () {
                            setState(() {
                              selectedShoes =
                                  shoeName; // Update the selected shoe
                            });
                    ...
                    child: Container(
                      child: Row(
                        children: [
                          ElevatedButton(
                            onPressed: () =>
                                _showShoeSelector(context, shoesData),
