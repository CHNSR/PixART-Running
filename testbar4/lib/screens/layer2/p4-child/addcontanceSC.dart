...
import 'package:testbar4/services/Fire_Challenge.dart';
import 'package:testbar4/widgets/ColorPicker.dart';
...
class _AddChallengeScState extends State<AddChallengeSc> {
  ...
  Color _parseColor(String colorString) {
    ...
    if (colorString.length == 6 || colorString.length == 7)
      buffer.write('ff'); // Add opacity if needed
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(10),
                                    border: Border.all(
                                        width: 2, color: Color(0xFF020826))),
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      borderSide:
                          BorderSide(color: Color(0xFF020826), width: 1),
                    ),
                ...
                child: Container(
                  ...
                  child: Text(
                    ...
                    overflow: TextOverflow
                        .ellipsis, // จำกัดให้ตัวหนังสือไม่ล้นออกจากกล่อง
