...
import 'package:testbar4/services/Fire_UserChallenge.dart';
import 'package:testbar4/provider/provider_userData.dart';
import 'package:testbar4/screens/layer2/p4-child/cardswiper.dart';
import 'package:testbar4/screens/layer2/p4-child/component.dart';
...
class _P4PlanState extends State<P4Plan> {
  ...
  final GlobalKey<CardswiperCPState> _cardswiperKey =
      GlobalKey<CardswiperCPState>();
  ...
  Future<void> loadChallengeStatuses() async {
    ...
    if (userId == null) {
      print(
          "[P4_Plan][loadChallengeStatuses] User ID is null, skipping fetch.");
      return;
    }
    try {
      ...
      setState(() {
        ...
        print(
            "[P4_Plan][loadChallengeStatuses] set status state: $challengeStatuses");
      });
    } catch (e) {
      print(
          "[P4_Plan][loadChallengeStatuses] Error loading challenge statuses: $e");
    }
  }
      ...
      body: Consumer<UserDataPV>(
        builder: (context, userDataPV, child) {
          if (userDataPV.userData == null) {
            print(
                "[P4_Plan] userdata in widget == null:${userDataPV.userData}");
            return const Center(
