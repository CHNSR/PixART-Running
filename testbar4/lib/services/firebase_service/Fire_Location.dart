...
class Locations {
  ...
  static Future<List<QueryDocumentSnapshot>> fetchPrivateLocations(String userId) async {
    try {
      final snapshot = await FirebaseFirestore.instance
          .collection('Location')
      ...
      snapshot.docs.forEach((doc) {
        print('[Fire_Location][fetchPrivateLocations] docId: ${doc.id}, data: ${doc.data()}');
      });
