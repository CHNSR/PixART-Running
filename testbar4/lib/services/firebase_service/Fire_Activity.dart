...
class Activity {
  ...
  static Future<int?> fetchNumOfWeeklyActivity(String runnerID) async {
    if (auth.currentUser == null) {
      print("[Fire Activity][fetchNumOfWeeklyActivity]------Error: No user logged in.");
    ...
    try {
      ...
      DateTime sunday = now.subtract(Duration(days: now.weekday)); // Start of the week (Sunday)
      DateTime saturday = sunday.add(Duration(days: 6)); // End of the week (Saturday)
      ...
      print("[Fire Activity][fetchNumOfWeeklyActivity]------Number of activities this week: $activityCount");

      return activityCount;
    } catch (e) {
      print("[Fire Activity][fetchNumOfWeeklyActivity]------Error fetching weekly activities: $e");
      return 0;
    }
  }
