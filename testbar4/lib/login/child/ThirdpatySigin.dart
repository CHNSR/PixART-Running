...
class ThirdPartySignIn {
  final GoogleSignIn _googleSignIn = GoogleSignIn(); // สร้าง instance ของ GoogleSignIn
  ...
  Future<User?> loginWithGoogle() async {
    try {
      final GoogleSignInAccount? googleUser = await _googleSignIn.signIn(); // เปิด Google Sign-In
